Contributing to exobot-adapter-twitch
======================

So you want to contribute to exobot-adapter-twitch? Fantastic! Here's a brief overview on
how best to do so.
...
[create an issue](https://github.com/exoplay/exobot-adapter-twitch/issues) before putting
...
1. [Fork the repository](https://github.com/exoplay/exobot-adapter-twitch/fork_select) to
  your Github account.
...
exobot-adapter-twitch is MIT licensed. See details in the LICENSE file. This is a very permissive
